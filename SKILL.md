...
| :--- | :---: | :--- | :--- |
| **1. Question** | **MEDIUM** | Standard Reasoning (`Gemini 2.0 Flash` / `Claude 3.7 Sonnet` / `GPT-4o`) | Fast interactive clarification, ambiguity detection. |
| **2. Research** | **HIGH** | Deep Reasoning / Thinking (`Gemini 2.5 Pro` / `Claude 3.7 Sonnet-Thinking` / `o3-mini`) | Codebase AST discovery, deep dependency graphs, blast radius. |
| **3. Structure** | **HIGH** | Deep Reasoning / Thinking (`Gemini 2.5 Pro` / `Claude 3.7 Sonnet-Thinking` / `o1`) | Architectural invariant design, interface contracts, trade-offs. |
| **4. Plan** | **HIGH** | Deep Reasoning / Thinking (`Gemini 2.5 Pro` / `Claude 3.7 Sonnet-Thinking`) | Atomic task breakdown, test strategy formulation. |
| **5. Implement** | **LOW / FAST** | Fast Code Execution (`Gemini 2.0 Flash-Lite` / `Claude 3.5 Haiku` / `GPT-4o-mini`) | Atomic file edits, test runner execution, linter verification. |
