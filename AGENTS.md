...
4. **Dogfooding & Modular Persistence:** Any complex feature or refactoring in this repository must use the modular `.qrspi/` session structure (`.qrspi/INDEX.md` and `.qrspi/sessions/YYYY-MM-DD_<slug>/1-question.md` through `5-implement.md`).
